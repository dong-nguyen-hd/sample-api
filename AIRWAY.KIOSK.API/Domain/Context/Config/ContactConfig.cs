...
/// <summary>
/// Chức năng: cấu hình schema cho bảng Contact
/// </summary>
public sealed class ContactConfig : IEntityTypeConfiguration<Model.Contact>
{
    public void Configure(EntityTypeBuilder<Model.Contact> entity)
    {
