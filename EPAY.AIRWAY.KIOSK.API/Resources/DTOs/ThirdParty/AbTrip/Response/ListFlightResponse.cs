...
public sealed class ListFlightResponse : BaseResponse
{
...
public sealed class FareData
    ...
    public class ListFlight
    {
        ...
        public List<ListPrice> ListPrice { get; set; }
    ...
    public class ListSegment
    {
        ...
        public QHItinerary QHItinerary { get; set; }

        [JsonPropertyName("QHFareInfo")]
        public object QHFareInfo { get; set; }
    }

    public class QHItinerary
    {
        [JsonPropertyName("flight_segment_group_id")]
        public int? FlightSegmentGroupId { get; set; }
        ...
        [JsonPropertyName("board_point")]
        public string? BoardPoint { get; set; }

        [JsonPropertyName("off_point")]
        ...
        [JsonPropertyName("is_through_flight")]
        public bool? IsThroughFlight { get; set; }

        [JsonPropertyName("is_dei_exists")]
        public bool? IsDeiExists { get; set; }
