...
public sealed class CreateOrderRequest : DecryptRequest
{
    ...
    /// <summary>
    /// Link trang Merchant trước khi chuyển sang trang DongND
    /// </summary>
    ...
    /// (Áp dụng khi sử dụng chức năng SSO qua ví DongND, trường walletFunctionType = 1 và paymentMethod = 01)
    /// </summary>
    ...
    /// 1: Thanh toán ví sử dụng web ví (Áp dụng khi sử dụng chức năng SSO qua ví DongND) <br/>
